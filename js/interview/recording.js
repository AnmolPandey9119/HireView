...
function showRecordingChoiceModal(onChoice) {
  ...
  `;
  modal.innerHTML = `
    <div style="background: linear-gradient(135deg, #1a1f3a, #2d1b4e); border: 1px solid rgba(198,93,58,0.3);
      ...
      <div style="display: flex; flex-direction: column; gap: 0.75rem;">
        <button onclick="handleRecordingChoice('download', this)" style="
          padding: 1rem 1.5rem; background: linear-gradient(135deg, #C65D3A, #E8935F);
